...
export const RouterAppRTC: React.FC = () => {
  const [debugVis, setDebugVis] = React.useState(false);
  const [mode, setMode] = React.useState<'slideshow' | 'slide' | 'circle' | 'gradient' | 'fade'>(DEFAULT_TRANSITION_MODE);
      ...
      <DebugVisProvider value={debugVis}>
        ...
        >
          <div className="flex items-center justify-between gap-2 mb-3">
            <h2 className="text-xl font-semibold">Idiomatic Router Demo (RTC)</h2>
            <button
